...
#ifndef _EasyButtonMCP_h
#define _EasyButtonMCP_h
...
#endif
	EasyButtonMCP(Adafruit_MCP23017 mcp, uint8_t pin, uint32_t debounce_time = 35, bool pullup_enable = true, bool invert = true) : _pin(pin), _db_time(debounce_time), _invert(invert), _pu_enabled(pullup_enable) {}
	~EasyButtonMCP() {}
	// PUBLIC FUNCTIONS
...
private:
	...
	Adafruit_MCP23017 _mcp;				// MCP library
